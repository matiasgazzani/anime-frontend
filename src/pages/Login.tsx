...
export const Login = () => {
  ...
  return (
    <main className='min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center px-6'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div>
              ...
              <input
                ...
                required
                className='w-full px-4 py-3 bg-gray-900/50 border-2 border-gray-700/50 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300'
